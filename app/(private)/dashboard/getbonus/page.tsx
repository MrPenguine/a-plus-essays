...
export default function GetBonusPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 pt-[100px]">
      <h1 className="text-2xl font-bold mb-8 text-gray-900 dark:text-white">Invite Friends & Earn</h1>

      {/* Main Card */}
      <Card className="relative overflow-hidden mb-10 dark:bg-gray-800">
        <div className="grid md:grid-cols-2 items-center">
          <div className="px-8 py-8 md:pr-4">
            <div className="max-w-md">
              <h2 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Invite a Friend</h2>
              <p className="text-secondary-gray-500 mb-6 text-gray-900 dark:text-white">
      ...
      <Card className="p-8 dark:bg-gray-800"> 
        <h2 className="text-xl font-semibold mb-6 text-gray-900 dark:text-white">How to Get the Bonus?</h2>
        ...
        <div className="mt-8 pt-8 border-t grid grid-cols-3 gap-4">
          <div className="text-center">
            <p className="text-2xl font-bold text-primary text-gray-900 dark:text-white">{stats.totalReferred}</p>
            <p className="text-sm text-secondary-gray-500 text-gray-900 dark:text-white">Friends Invited</p>
          </div>
          <div className="text-center">
            <p className="text-2xl font-bold text-primary text-gray-900 dark:text-white">{stats.pendingRedemptions}</p>
            <p className="text-sm text-secondary-gray-500 text-gray-900 dark:text-white">Pending Bonuses</p>
          </div>
          <div className="text-center">
            <p className="text-2xl font-bold text-primary text-gray-900 dark:text-white">{stats.redeemedCount}</p>
            <p className="text-sm text-secondary-gray-500 text-gray-900 dark:text-white">Bonuses Redeemed</p>
          </div>
        </div>
      </Card>
    </div>
